...
templates['cart'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <div class=\"col-4\">\n                "
    ...
    + "$\n            </div>\n            <div class=\"col-2 btn btn-danger delete-button\" id=\""
  ...
  return "            <div class=\"col-4\">\n                "
    ...
    + "\n            </div>\n            <div class=\"offset-4 col-2 price\">\n                Price: "
    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
    + "$\n            </div>\n            <div class=\"col-2 btn btn-danger delete-button\" id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" data-price=\""
  ...
  return "<div class=\"container border border-primary rounded fixed-top\" id='cart'>\n    <div class=\"row\">\n        <div class=\"col-4\">\n            <h5>Shopping Cart</h5>\n        </div>\n        <div class=\"offset-4 col-4\">\n            <div class=\"btn btn-outline-primary\" id=\"back-to-shopping\">\n                Back To Shopping\n            </div>\n        </div>\n    </div>\n    <div class=\"row\" id=\"pizza-row\">\n        <h5 class=\"col-4\">Pizzas:</h5>\n    </div>\n    <div class=\"row\" id=\"pizza-container\">\n"
    ...
    + "    </div>\n    <div class=\"row\">\n        <div class=\"offset-8 col-4\">\n            <div id=\"discount\">\n                5% Discount\n            </div>\n            <div id=\"discount-checkbox\" class=\"checkbox disabled-custom\">\n                <label><input type=\"checkbox\" id=\"cb\" value=\"\">Use Discount</label>\n            </div>\n            <div id=\"login-button\" class=\"btn btn-primary\">\n                Log In\n            </div>\n            <div id=\"register-button\" class=\"btn btn-danger\">\n                Register\n            </div>\n            <h6 id=\"total\">Total: "
...
templates['loginForm'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"container border border-primary rounded fixed-top\" id=\"login-form\">\n    <div class=\"row\">\n        <div class=\"offset-8 col-4\">\n            <div class=\"btn btn-outline-primary\" id=\"back-to-shopping-from-login\">\n                Back To Shopping\n            </div>\n        </div>\n    </div>\n    <div class=\"row\">\n        <div class=\"col-6 offset-3\">\n            <h3>Login Form</h3>\n            <form>\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Your Username\" id=\"login-username\" value=\"\" />\n                </div>\n                <div class=\"form-group\">\n                    <input type=\"password\" class=\"form-control\" placeholder=\"Your Password\" id=\"login-password\" value=\"\" />\n                </div>\n                <div class=\"btn btn-primary\" id=\"send-login-button\">\n                    Log In\n                </div>\n            </form>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
...
templates['registrationForm'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"container border border-primary rounded fixed-top\" id=\"registration-form\">\n    <div class=\"row\">\n        <div class=\"offset-8 col-4\">\n            <div class=\"btn btn-outline-primary\" id=\"back-to-shopping-from-registration\">\n                Back To Shopping\n            </div>\n        </div>\n    </div>\n    <div class=\"row\">\n        <div class=\"col-6 offset-3\">\n            <h3>Registration Form</h3>\n            <form>\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Your Username\" id=\"registration-username\" value=\"\" />\n                </div>\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Your Name\" id=\"registration-name\" value=\"\" />\n                </div>\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Your Surname\" id=\"registration-surname\" value=\"\" />\n                </div>\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Your Email\" id=\"registration-email\" value=\"\" />\n                </div>\n                <div class=\"form-group\">\n                    <input type=\"password\" class=\"form-control\" placeholder=\"Your Password\" id=\"registration-password\" value=\"\" />\n                </div>\n                <div class=\"btn btn-primary\" id=\"send-registration-button\">\n                    Register\n                </div>\n            </form>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
